...
### Core Library
```bash
dotnet add package DiagnosticsToolkit --version 1.0.0
```

### ASP.NET Core Integration
```bash
dotnet add package DiagnosticsToolkit.AspNetCore --version 1.0.0
```

### .NET MAUI Integration
```bash
dotnet add package DiagnosticsToolkit.Maui --version 1.0.0
```

### Source Generator (for code generation)
```bash
dotnet add package DiagnosticsToolkit.Generators --version 1.0.0
```

### AI-Assisted Diagnostics CLI
```bash
dotnet tool install --global DiagnosticsToolkit.Cli --version 1.0.0
```

Or use Visual Studio Package Manager:
- `Install-Package DiagnosticsToolkit -Version 1.0.0`
- `Install-Package DiagnosticsToolkit.AspNetCore -Version 1.0.0`
- `Install-Package DiagnosticsToolkit.Maui -Version 1.0.0`
- `Install-Package DiagnosticsToolkit.Generators -Version 1.0.0` 
