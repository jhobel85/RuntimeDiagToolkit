...
";
    ...
    private static string GenerateMetricsHelper(MethodInfo method)
    {
        ...
        sb.AppendLine("    private static readonly double TimestampToMilliseconds = 1000.0 / Stopwatch.Frequency;");
        sb.AppendLine();
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        var stopwatch = ValueStopwatch.StartNew();");
        sb.AppendLine("        try");
        sb.AppendLine("        {");
        ...
        sb.AppendLine();
        sb.AppendLine("    private readonly record struct ValueStopwatch(long StartTimestamp)");
        sb.AppendLine("    {");
        sb.AppendLine("        public static ValueStopwatch StartNew() => new ValueStopwatch(Stopwatch.GetTimestamp());");
        sb.AppendLine("        public long ElapsedMilliseconds => (long)((Stopwatch.GetTimestamp() - StartTimestamp) * TimestampToMilliseconds);");
        sb.AppendLine("    }");
        sb.AppendLine();
